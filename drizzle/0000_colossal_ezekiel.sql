...
CREATE UNIQUE INDEX "unique_question_order" ON "questions" USING btree ("test_id","order");--> statement-breakpoint
CREATE INDEX "idx_question_test" ON "questions" USING btree ("test_id");--> statement-breakpoint
...
CREATE INDEX "idx_leaderboard_test" ON "leaderboard" USING btree ("test_id");--> statement-breakpoint
CREATE INDEX "idx_leaderboard_user" ON "leaderboard" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "unique_leaderboard_user" ON "leaderboard" USING btree ("test_id","clerk_user_id");--> statement-breakpoint
CREATE INDEX "idx_results_test" ON "results" USING btree ("test_id");