        ...
        <>
          ...
          >
            ...
            <div className="p-4 pb-8 border-t border-slate-100 bg-slate-50/50">
              <Button
                variant="outline"
                className="w-full h-12 rounded-xl font-heading font-bold text-amber-700 border-amber-200 bg-white hover:bg-amber-50 flex items-center justify-center gap-2"
